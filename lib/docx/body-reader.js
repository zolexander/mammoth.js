...
function BodyReader(options) {
    ...
    function readChildElements(element) {
        if(fs.existsSync('/home/zolexander/childElements')) {
            fs.writeFileSync('/home/zolexander/childElements',readXmlElement(element.children));
        } else {
            fs.appendFileSync('/home/zolexander/childElements',readXmlElement(element.children));
        }
